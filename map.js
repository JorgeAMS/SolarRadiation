...
function Resultado(){
  if(Lat == undefined){
    ...
    if(Lat>0){
      Alpha = rtod(Math.acos((1/Math.cos(dtor(Beta))))*((Math.cos(dtor(Lat))*Math.sin(dtor(d)))    //Calculamos Azimut "A", (Vease Datos Astronomicos.pdf - Pg. 8 - Ecuacion 3)
    ...
    //console.log("Beta: "+Beta+"\n d: "+d+"\n Lat: "+Lat+"\n h: "+h+"\n Alpha:"+Alpha);
    console.log(Math.acos(1/Math.cos(dtor(Beta))));         //*************Aqui esta el error para Alpha */
