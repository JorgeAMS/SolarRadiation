...
function Resultado(){
  if(Lat == undefined){
    ...
    var giro = document.getElementById('Giro');                             //Obtenemos el Angulo de giro del colector (Alpha2)
    var inclinacion = document.getElementById('Inclinacion');               //Obtenemos la Inclinacion del colector (Beta2)
    ...
    var Tetta = Math.acos(Math.sin(Beta)*Math.cos(inclinacion)             //*Calculamos Tetta "0", (Vease Datos Astronomicos.pdf - Pg. 9) Falta saber q es a2.
                  +Math.cos(Beta)*Math.sin(inclinacion)
                  *Math.cos(Alpha-giro));        
    ...
    var Id = Idn*Math.cos(Tetta);                                            //Calculamos ID, (Vease Ecuacion del tiempo2.pdf - Pg. 9) *Falta calcular Tetta*
